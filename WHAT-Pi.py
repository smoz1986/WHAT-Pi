...
def runShellScript():
	import subprocess
	subprocess.call(['/root/WHAT-Pi/./SURVEY-LAUNCH.sh'])
...
def runShellScript1():
	import subprocess
	subprocess.call(['/root/WHAT-Pi/./EXPLOIT-LAUNCH.sh'])
...
def runShellScript2():
	import subprocess
	subprocess.call(['/root/WHAT-Pi/./GEO-LAUNCH.sh'])
...
def runShellScript3():
	import subprocess
	subprocess.call(['/root/WHAT-Pi/./COMMS-LAUNCH.sh'])
...
def runShellScript4():
	import subprocess
	subprocess.call(['/root/WHAT-Pi/./FOLDERS-LAUNCH.sh'])
