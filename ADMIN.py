...
def runShellScript5():
	import subprocess
	subprocess.call(['/root/WHAT-Pi/./WIPE-CREATE-LAUNCH.sh'])
...
def runShellScript6():
	import subprocess
	subprocess.call(['/root/WHAT-Pi/./DB-LAUNCH.sh'])
...
def runShellScript7():
	import subprocess
	subprocess.call(['/root/WHAT-Pi/./ARCHIVE-LAUNCH.sh'])
...
def runShellScript3():
	import subprocess
	subprocess.call(['/root/WHAT-Pi/./CLEAR-ARCHIVE-LAUNCH.sh'])
